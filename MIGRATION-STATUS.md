...
| 6 | `react` | `rules/react/*`, relevant common UI rules, React-specific portions of `patterns/foundational-ui-components.md` | Complete | Created as a standalone React skill with focused references for state and data flow, styling and theming, and foundational component guidance, plus copyable foundational button, input, and theme-toggle examples. React testing guidance is intentionally owned by `testing` |
